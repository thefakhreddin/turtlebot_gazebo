...
if(NOT "/home/thefakhreddin/turtlebot_gazebo/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nuturtlebot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thefakhreddin/turtlebot_gazebo/src/nuturtlebot/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(nuturtlebot_EXPORTED_TARGETS ${${nuturtlebot_dep}_EXPORTED_TARGETS})
endforeach()
