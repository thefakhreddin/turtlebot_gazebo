...
if("TRUE" STREQUAL "TRUE")
  set(mpc_local_planner_SOURCE_PREFIX /home/thefakhreddin/turtlebot_gazebo/src/mpc_local_planner/mpc_local_planner)
  set(mpc_local_planner_DEVEL_PREFIX /home/thefakhreddin/turtlebot_gazebo/devel)
  ...
  set(mpc_local_planner_INSTALL_PREFIX /home/thefakhreddin/turtlebot_gazebo/install)
...
if(NOT "/home/thefakhreddin/turtlebot_gazebo/devel/include;/home/thefakhreddin/turtlebot_gazebo/src/mpc_local_planner/mpc_local_planner/include;/usr/include/eigen3 " STREQUAL " ")
  set(mpc_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/thefakhreddin/turtlebot_gazebo/devel/include;/home/thefakhreddin/turtlebot_gazebo/src/mpc_local_planner/mpc_local_planner/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thefakhreddin/turtlebot_gazebo/src/mpc_local_planner/mpc_local_planner/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mpc_local_planner_EXPORTED_TARGETS ${${mpc_local_planner_dep}_EXPORTED_TARGETS})
endforeach()
