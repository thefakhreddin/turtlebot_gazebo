...
namespace mpc_local_planner
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(FootprintReconfigureConfig &config, const FootprintReconfigureConfig &max, const FootprintReconfigureConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const FootprintReconfigureConfig &config1, const FootprintReconfigureConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, FootprintReconfigureConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const FootprintReconfigureConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, FootprintReconfigureConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const FootprintReconfigureConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const FootprintReconfigureConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, FootprintReconfigureConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 20 "/home/thefakhreddin/turtlebot_gazebo/src/mpc_local_planner/mpc_local_planner/cfg/mpc_footprint.cfg"
      bool is_footprint_dynamic;
