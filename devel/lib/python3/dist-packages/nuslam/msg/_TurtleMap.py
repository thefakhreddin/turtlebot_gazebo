...
"""autogenerated by genpy from nuslam/TurtleMap.msg. Do not edit."""
import codecs
import sys
...
class TurtleMap(genpy.Message):
  _md5sum = "2d40027dbb6d72b6b7d7e7a1e02116dc"
  _type = "nuslam/TurtleMap"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# feature map
# header 
Header header
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TurtleMap, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.cx = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.cy = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
