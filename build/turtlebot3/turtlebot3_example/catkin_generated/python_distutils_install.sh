...
echo_and_run cd "/home/thefakhreddin/turtlebot_gazebo/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/home/thefakhreddin/turtlebot_gazebo/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/thefakhreddin/turtlebot_gazebo/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
